...
const cases: CaseItem[] = [
  ...
  { id: 'promo-visual', title: 'Promotional Image & Product Visual System', category: 'Visuals', description: 'Transforming raw product shots into polished promotional visuals.', brief: 'Raw product image to final commercial poster.', problem: 'Raw photos lacked message hierarchy.', process: 'Prompt direction → composition planning → campaign outputs.', output: 'Poster sets and sales-ready visuals.', tools: ['Prompt engineering', 'Layout systems'], visualType: 'visual', coverImage: '/cases/product-visuals/cover.png' },
  ...
  { id: 'b2b-outreach', title: 'B2B Outreach Workflow', category: 'Outreach', description: 'Turning company research into tailored outreach messaging systems.', brief: 'Repeatable outreach powered by company context.', problem: 'Messaging quality dropped without research depth.', process: 'Account brief → message framework → follow-up timeline.', output: 'Message cards and outreach calendars.', tools: ['CRM board', 'Templates'], visualType: 'research', coverImage: '/cases/outreach-workflow/cover.png' }
];
